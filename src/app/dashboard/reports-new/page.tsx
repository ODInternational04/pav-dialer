          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600 mt-2">
                {stats?.systemStats?.overall_success_rate?.toFixed(1) || 0}%
              </p>
            </div>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {callLogs.map((log) => (
              <tr key={log.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm font-medium text-gray-900">{log.clients.name}</div>
          ...
          <>
            ...
            {activeTab === 'feedback' && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Feedback Analysis</h3>
                <p className="text-gray-600">Comprehensive feedback analysis coming soon...</p>
              </div>
            )}
          </>
        )}
